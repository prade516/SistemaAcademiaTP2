<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Inscripcion.master" AutoEventWireup="true" CodeBehind="frmaltacursado.aspx.cs" Inherits="UI.Web.Formulario.frmaltacursado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Contenidoprincipal" runat="server">
    ...
    <asp:GridView ID="gridview" runat="server"  AutoGenerateColumns="False" CssClass="mGrid" PagerStyle-CssClass="pgr" GridLines="None"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Comision" DataField="Desc_materia"/>
